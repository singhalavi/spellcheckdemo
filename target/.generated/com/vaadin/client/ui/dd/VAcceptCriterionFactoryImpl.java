...
public class VAcceptCriterionFactoryImpl extends com.vaadin.client.ui.dd.VAcceptCriterionFactory {
  public VAcceptCriterion get(String name) {
    name = name.intern();
    if ("com.vaadin.ui.AbstractSelect.AcceptItem" == name) return GWT.create(com.vaadin.client.ui.dd.VItemIdIs.class );
    ...
    else if ("com.vaadin.event.dd.acceptcriteria.AcceptAll" == name) return GWT.create(com.vaadin.client.ui.dd.VAcceptAll.class );
