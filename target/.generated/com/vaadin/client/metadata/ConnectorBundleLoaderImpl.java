...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.NativeButton","com.vaadin.ui.TwinColSelect","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.PopupView","com.vaadin.ui.Button","com.vaadin.ui.FormLayout","com.vaadin.ui.UI","com.vaadin.ui.Upload","com.vaadin.ui.DateField","com.vaadin.ui.TextField","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.TreeTable","com.vaadin.ui.Image","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.Label","com.vaadin.server.FileDownloader","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Flash","com.vaadin.ui.JavaScript","com.vaadin.ui.Tree","com.vaadin.ui.Accordion","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.ComboBox","com.vaadin.ui.CustomField","com.vaadin.ui.Window","com.vaadin.ui.GridLayout","com.vaadin.ui.MenuBar","com.vaadin.ui.TabSheet","com.vaadin.ui.Audio","com.vaadin.ui.NativeSelect","com.vaadin.ui.CustomLayout","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.Link","com.vaadin.ui.OptionGroup","com.vaadin.ui.InlineDateField","com.vaadin.ui.ListSelect","com.vaadin.ui.CssLayout","com.vaadin.ui.TextArea","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.BrowserFrame","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.CustomComponent","com.vaadin.ui.PasswordField","com.vaadin.ui.Slider","com.vaadin.ui.Video","com.vaadin.ui.Embedded","com.vaadin.ui.Table","com.vaadin.ui.Form","com.vaadin.ui.CheckBox","com.vaadin.ui.Panel","com.vaadin.server.AbstractJavaScriptExtension",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"propertyReadOnly", "caption", "registeredEventListeners", "readOnly", "immediate", "enabled", "modified", "errorMessage", "primaryStyleName", "height", "styles", "hideErrors", "description", "id", "tabIndex", "width", "required", "resources", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"button", "ctrlKey", "shiftKey", "metaKey", "type", "altKey", "relativeY", "relativeX", "clientY", "clientX", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"caption", "styles", "width", "resources", "html", "hideOnMouseOut", "id", "immediate", "registeredEventListeners", "errorMessage", "height", "enabled", "description", "primaryStyleName", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"resources", "height", "enabled", "caption", "errorMessage", "id", "width", "styles", "firstChild", "primaryStyleName", "splitterState", "secondChild", "readOnly", "registeredEventListeners", "immediate", "description", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"registeredEventListeners", "enabled", "caption", "width", "errorMessage", "styles", "id", "resources", "primaryStyleName", "immediate", "alternateText", "height", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"resources", "text", "primaryStyleName", "maxLength", "registeredEventListeners", "height", "errorMessage", "modified", "rows", "wordwrap", "immediate", "styles", "hideErrors", "required", "propertyReadOnly", "width", "id", "tabIndex", "caption", "columns", "inputPrompt", "enabled", "readOnly", "description", });
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"id", "primaryStyleName", "enabled", "readOnly", "description", "styles", "registeredEventListeners", "width", "caption", "errorMessage", "resources", "height", "immediate", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"immediate", "errorMessage", "tabIndex", "caption", "readOnly", "enabled", "propertyReadOnly", "height", "resources", "primaryStyleName", "layout", "hideErrors", "width", "id", "styles", "description", "modified", "footer", "registeredEventListeners", "required", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"id", "caption", "primaryStyleName", "tabIndex", "immediate", "width", "description", "htmlContentAllowed", "height", "errorMessage", "registeredEventListeners", "clickShortcutKeyCode", "enabled", "resources", "readOnly", "disableOnClick", "styles", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"registeredEventListeners", "immediate", "resources", "id", "readOnly", "description", "styles", "height", "tabIndex", "width", "enabled", "primaryStyleName", "errorMessage", "caption", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"row2", "row1", "column2", "column1", "alignment", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"showControls", "sourceTypes", "height", "caption", "readOnly", "id", "description", "enabled", "muted", "sources", "resources", "htmlContentAllowed", "primaryStyleName", "registeredEventListeners", "immediate", "altText", "errorMessage", "styles", "autoplay", "width", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"registeredEventListeners", "resources", "caption", "id", "enabled", "callbackNames", "immediate", "styles", "readOnly", "description", "rpcInterfaces", "width", "primaryStyleName", "errorMessage", "height", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"id", "readOnly", "errorMessage", "caption", "templateContents", "immediate", "primaryStyleName", "resources", "height", "description", "templateName", "registeredEventListeners", "enabled", "width", "styles", "childLocations", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"width", "caption", "id", "primaryStyleName", "marginsBitmask", "errorMessage", "resources", "immediate", "description", "styles", "enabled", "spacing", "height", "childData", "registeredEventListeners", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"errorMessage", "height", "resources", "required", "immediate", "registeredEventListeners", "description", "caption", "hideErrors", "styles", "tabIndex", "id", "enabled", "propertyReadOnly", "primaryStyleName", "modified", "width", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"errorMessage", "resources", "caption", "width", "enabled", "readOnly", "styles", "id", "childCss", "description", "registeredEventListeners", "height", "primaryStyleName", "immediate", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"styles", "modified", "enabled", "propertyReadOnly", "hideErrors", "readOnly", "resources", "immediate", "description", "id", "required", "errorMessage", "primaryStyleName", "height", "registeredEventListeners", "caption", "tabIndex", "width", });
            ...
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"id", "enabled", "height", "description", "caption", "errorMessage", "immediate", "resources", "primaryStyleName", "tabIndex", "readOnly", "propertyReadOnly", "hideErrors", "styles", "modified", "registeredEventListeners", "required", "width", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"width", "id", "primaryStyleName", "caption", "resources", "description", "readOnly", "enabled", "errorMessage", "styles", "height", "immediate", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"description", "immediate", "height", "hideErrors", "enabled", "errorMessage", "primaryStyleName", "required", "propertyReadOnly", "width", "resources", "registeredEventListeners", "styles", "modified", "tabIndex", "readOnly", "id", "caption", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"description", "styles", "width", "errorMessage", "tabIndex", "orientation", "readOnly", "enabled", "registeredEventListeners", "resolution", "required", "id", "resources", "value", "height", "minValue", "caption", "primaryStyleName", "immediate", "maxValue", "hideErrors", "modified", "propertyReadOnly", });
            ...
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"resources", "height", "modified", "enabled", "readOnly", "propertyReadOnly", "immediate", "tabIndex", "width", "styles", "required", "errorMessage", "caption", "registeredEventListeners", "description", "id", "primaryStyleName", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"description", "caption", "sources", "enabled", "registeredEventListeners", "errorMessage", "primaryStyleName", "immediate", "styles", "altText", "readOnly", "htmlContentAllowed", "width", "id", "resources", "autoplay", "muted", "sourceTypes", "showControls", "height", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"height", "registeredEventListeners", "immediate", "caption", "errorMessage", "alternateText", "id", "enabled", "readOnly", "primaryStyleName", "styles", "description", "resources", "width", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"rpcInterfaces", "enabled", "callbackNames", "registeredEventListeners", "resources", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"primaryStyleName", "resources", "caption", "childData", "marginsBitmask", "width", "styles", "height", "description", "registeredEventListeners", "id", "errorMessage", "spacing", "rows", "readOnly", "immediate", "columns", "enabled", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"immediate", "errorMessage", "id", "marginsBitmask", "styles", "enabled", "readOnly", "resources", "registeredEventListeners", "spacing", "height", "childData", "width", "description", "primaryStyleName", "caption", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"id", "styles", "resizable", "draggable", "centered", "tabIndex", "primaryStyleName", "enabled", "caption", "readOnly", "positionX", "width", "immediate", "positionY", "registeredEventListeners", "modal", "resources", "height", "description", "resizeLazy", "scrollTop", "scrollLeft", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"description", "registeredEventListeners", "width", "caption", "id", "immediate", "height", "styles", "enabled", "resources", "connectorToCssPosition", "readOnly", "primaryStyleName", "errorMessage", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"registeredEventListeners", "resources", "enabled", "names", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"width", "caption", "id", "registeredEventListeners", "errorMessage", "immediate", "firstChild", "secondChild", "primaryStyleName", "resources", "description", "splitterState", "height", "readOnly", "styles", "enabled", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"minPositionUnit", "positionUnit", "locked", "maxPosition", "maxPositionUnit", "minPosition", "position", "positionReversed", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"readOnly", "enabled", "errorMessage", "height", "hideErrors", "styles", "resources", "primaryStyleName", "caption", "checked", "id", "registeredEventListeners", "modified", "tabIndex", "propertyReadOnly", "required", "immediate", "description", "width", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"id", "text", "hideErrors", "tabIndex", "propertyReadOnly", "modified", "height", "description", "registeredEventListeners", "caption", "immediate", "maxLength", "enabled", "errorMessage", "primaryStyleName", "width", "styles", "readOnly", "columns", "required", "resources", "inputPrompt", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"caption", "resources", "styles", "id", "clickShortcutKeyCode", "errorMessage", "readOnly", "enabled", "primaryStyleName", "description", "immediate", "disableOnClick", "height", "width", "registeredEventListeners", "htmlContentAllowed", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"caption", "id", "primaryStyleName", "enabled", "registeredEventListeners", "contentMode", "width", "height", "readOnly", "immediate", "errorMessage", "resources", "description", "styles", "text", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"styles", "resources", "caption", "height", "primaryStyleName", "immediate", "childData", "description", "enabled", "width", "id", "errorMessage", "spacing", "readOnly", "marginsBitmask", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"width", "primaryStyleName", "readOnly", "registeredEventListeners", "resources", "description", "styles", "enabled", "caption", "id", "height", "immediate", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"primaryStyleName", "registeredEventListeners", "enabled", "id", "immediate", "description", "width", "readOnly", "styles", "resources", "height", "alternateText", "caption", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"tabIndex", "width", "caption", "readOnly", "styles", "scrollLeft", "id", "scrollTop", "enabled", "registeredEventListeners", "height", "primaryStyleName", "resources", "description", "errorMessage", "immediate", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"registeredEventListeners", "classId", "codetype", "immediate", "description", "id", "width", "standby", "resources", "enabled", "errorMessage", "primaryStyleName", "embedParams", "archive", "codebase", "readOnly", "alternateText", "caption", "height", "styles", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"height", "caption", "enabled", "width", "immediate", "readOnly", "resources", "styles", "description", "registeredEventListeners", "id", "primaryStyleName", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"immediate", "hideErrors", "tabIndex", "description", "styles", "height", "caption", "width", "primaryStyleName", "enabled", "id", "textFieldEnabled", "modified", "readOnly", "resources", "required", "registeredEventListeners", "errorMessage", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"enabled", "parameters", "primaryStyleName", "target", "errorMessage", "uriFragment", "features", "registeredEventListeners", "readOnly", "description", "caption", "height", "id", "width", "immediate", "styles", "resources", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"hideErrors", "primaryStyleName", "tabIndex", "immediate", "indeterminate", "pollingInterval", "width", "resources", "id", "enabled", "height", "propertyReadOnly", "caption", "description", "registeredEventListeners", "errorMessage", "modified", "state", "required", "styles", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"primaryStyleName", "propertyReadOnly", "id", "registeredEventListeners", "hideErrors", "enabled", "errorMessage", "immediate", "readOnly", "width", "required", "modified", "resources", "description", "height", "caption", "styles", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"enabled", "resources", "propertyReadOnly", "modified", "primaryStyleName", "caption", "immediate", "errorMessage", "description", "readOnly", "hideErrors", "registeredEventListeners", "required", "tabIndex", "id", "width", "styles", "height", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"bgColor", "registeredEventListeners", "readOnly", "enabled", "immediate", "styles", "errorMessage", "caption", "width", "description", "resources", "id", "height", "primaryStyleName", "cursorX", "cursorY", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"registeredEventListeners", "enabled", "readOnly", "primaryStyleName", "htmlContentAllowed", "height", "width", "immediate", "styles", "id", "showDefaultCaption", "caption", "errorMessage", "description", "color", "popupVisible", "resources", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"primaryStyleName", "styles", "rowCount", "changedColor", "readOnly", "immediate", "resources", "changedY", "changedX", "id", "errorMessage", "columnCount", "caption", "height", "width", "description", "registeredEventListeners", "enabled", });
